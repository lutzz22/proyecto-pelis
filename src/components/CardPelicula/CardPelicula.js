...
const CardPelicula = (props) => {
  ...
  const {id, backdrop_path, title, vote_average, peli} = props;
    ...
    <div>
        <div className="card mb-3" style={{width: "14rem"}}>
          ...
          <div className="card-body">
              ...
              <a href="#"  onClick={()=> addFavoritos(peli)}><i className="cora bi bi-suit-heart"></i></a> <a style={{fontSize: "small"}}>Calificación: {vote_average}</a>
